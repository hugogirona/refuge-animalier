...
Route::middleware(['auth'])->group(function () {
    ...
    Route::livewire('/admin/pets/{pet}', 'pages::admin.pets.show')->name('admin-pets.show');
    Route::livewire('/admin/adoptions', 'pages::admin.adoptions.index')->name('adoptions.index');
    Route::livewire('/admin/adoptions/{adoption}', 'pages::admin.adoptions.show')->name('adoptions.show');
