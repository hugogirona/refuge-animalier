...
<x-layout type="guest" :title="__('guest/adoption.confirmation.page_title')">
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-grayscale-text-title mb-4">
                    {{ __('guest/adoption.confirmation.title') }}
                </h1>

                <p class="text-lg md:text-xl text-grayscale-text-subtitle">
                    {{ __('guest/adoption.confirmation.subtitle', ['name' => $petName]) }}
                </p>
            </div>
            ...
            <div class="bg-white rounded-xl border border-neutral-200 p-6 md:p-8 mb-6 shadow-sm">
                <p class="text-neutral-700 leading-relaxed mb-6">
                    <strong>{{ __('guest/adoption.confirmation.greeting', ['firstname' => $firstName]) }}</strong>
                    {!! __('guest/adoption.confirmation.intro', ['petname' => '<strong>' . $petName . '</strong>']) !!}
                </p>
                ...
                <section class="bg-secondary-surface-default-subtle border border-secondary-border-default-subtle rounded-xl p-6 mb-6">
                    <h2 class="text-xl font-bold text-grayscale-text-title mb-6">
                        {{ __('guest/adoption.confirmation.next_steps.title') }}
                    </h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 pt-1">
                                <p class="text-grayscale-text-title leading-relaxed">
                                    {{ __('guest/adoption.confirmation.next_steps.step_1') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 pt-1">
                                <p class="text-grayscale-text-title leading-relaxed">
                                    {{ __('guest/adoption.confirmation.next_steps.step_2') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 pt-1">
                                <p class="text-grayscale-text-title leading-relaxed">
                                    {{ __('guest/adoption.confirmation.next_steps.step_3') }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section class="border-t border-neutral-200 pt-6">
                    <h2 class="text-xl font-bold text-grayscale-text-title mb-4">
                        {{ __('guest/adoption.confirmation.questions.title') }}
                    </h2>
                    <p class="text-grayscale-text-subtitle mb-4">
                        {{ __('guest/adoption.confirmation.questions.subtitle') }}
                    </p>
            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                >
                    {{ __('guest/adoption.confirmation.actions.view_other_pets') }}
                </x-cta-button>
                ...
                <x-cta-button
                    ...
                    class="w-full justify-center"
                >
                    {{ __('guest/adoption.confirmation.actions.back_home') }}
                </x-cta-button>
            </div>
