    ...
    <div class="container mx-auto px-4 py-12 md:py-16">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                {{-- SVG + Title --}}
                <div
                    class="inline-flex items-center justify-center w-24 h-24 md:w-32 md:h-32 bg-success-surface-default-subtle rounded-full mb-6 animate-scale-in">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-grayscale-text-title mb-4">Demande envoyée !</h1>

                <p class="text-lg md:text-xl text-grayscale-text-subtitle">Merci pour votre intérêt pour Moka</p>
            </div>
            ...
            <div class="bg-white rounded-xl border border-neutral-200 p-6 md:p-8 mb-6 shadow-sm">
                <p class="text-neutral-700 leading-relaxed mb-6">
                    <strong>Bonjour Sarah,</strong> nous avons bien reçu votre demande d'adoption pour
                    <strong>Moka</strong>.
                </p>


                <section  class="bg-secondary-surface-default-subtle border border-secondary-border-default-subtle rounded-xl p-6 mb-6">
                    <h2 class="text-xl font-bold text-grayscale-text-title mb-6">Et maintenant...</h2>

                    <div class="space-y-4">
                        {{-- Step 1 --}}
                        <div class="flex items-start gap-4">
                            <div
                                class="w-10 h-10 bg-primary-surface-default text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">
                                1
                            </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 pt-1">
                                <p class="text-grayscale-text-title leading-relaxed">
                                    Nous étudions activement votre dossier
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 pt-1">
                                <p class="text-grayscale-text-title leading-relaxed">
                                    Nous vous recontacterons sous 48h à 72h hors week-end et jours fériés
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section class="border-t border-neutral-200 pt-6 ">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="mailto:contact@pattesheureuses.be"
                           class="flex items-center gap-3 text-primary-text-link-light hover:underline underline-offset-3 transition-colors">
                            <svg class="w-5 h-5 flex-shrink-0 fill-current" viewBox="0 0 24 24">
                                <path
