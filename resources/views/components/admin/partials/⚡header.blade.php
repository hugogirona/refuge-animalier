...
<header class="bg-white border-b border-neutral-200 sticky top-0 z-40">
    <div class="px-4 py-1 sm:py-3 lg:px-6">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-2">
                ...
                <x-admin.navigation.public-site-link
                    href="{{ route('home') }}"
                ...
                <x-admin.user-menu
                    ...
                    :userRole="$this->user->role === UserRoles::ADMIN->value ? 'Administrateur' : 'Bénévole'"
                    :userAvatar="$this->user->thumbnail_url"
                />
            </div>
