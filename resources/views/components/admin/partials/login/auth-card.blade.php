        ...
        <fieldset class="space-y-6 mb-12">
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center">
                    ...
                    >
                    <span class="ml-2 text-sm text-grayscale-text-subtitle">Se souvenir de moi</span>
                </label>

                <a href="{{ route('password.request') }}"
                   class="text-sm text-primary-text-link-light hover:text-primary-text-link-label font-medium">
                    Mot de passe oublié ?
                </a>
            </div>
        </fieldset>
