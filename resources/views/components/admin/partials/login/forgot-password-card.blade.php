...
<div class="bg-white rounded-xl shadow-xl border border-neutral-200 p-8 flex flex-col gap-6">
        ...
        <fieldset class="space-y-6 mb-12">
            ...
            <div class="mt-6 bg-secondary-surface-default-subtle border border-secondary-border-default-subtle rounded-xl p-4">
                <div class="flex items-start gap-3">
                    <svg class="w-5 h-5 text-secondary-surface-default shrink-0 mt-0.5 fill-current" viewBox="0 0 24 24">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/>
                    </svg>
                    <p class="text-grayscale-text-body text-sm">
                        Nous vous enverrons un lien de réinitialisation à cette adresse si l’email fourni se trouve dans notre base de données.
                    </p>
                </div>
            </div>
        </fieldset>

        <x-cta-button role="button" type="submit" class="w-full">Envoyer le lien</x-cta-button>
    ...
    <div class="text-center">
        <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-primary-500 hover:text-primary-600 transition-colors text-sm font-medium">
