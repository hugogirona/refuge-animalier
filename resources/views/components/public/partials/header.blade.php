<header class="bg-white shadow-sm w-full fixed top-0 z-40" x-data="{ menuOpen: false }">
    <div class="mx-auto md:px-8 px-5">
        <div class="flex items-center justify-between h-16 md:h-20">
            ...
            <x-public.navigation.navbar-desktop/>
        </div>
    </div>
