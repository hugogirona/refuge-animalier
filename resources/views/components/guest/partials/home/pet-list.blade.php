...
<section class="pet-list-section py-8 px-4 bg-grayscale-negative">
    <div class="container mx-auto  flex flex-col items-center justify-center ">

        <div class="mb-6 flex flex-col align-start space-y-1">
            <h2 class="text-2xl font-semibold">
                Ils attendent une famille
            </h2>
            <p class="text-lg text-grayscale-text-subtle">
