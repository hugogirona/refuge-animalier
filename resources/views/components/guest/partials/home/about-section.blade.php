...
<x-text-media
    :title="__('guest/home.hero.about_title')"
    image="home/cat-about"
    :image_alt="__('guest/home.hero.about_image_alt')"
    image_ratio="video"
    bg_color="bg-primary-surface-default-subtle"
    :button_text="__('guest/home.hero.about_button_text')"
    :button_href="route('about')"
    :paragraphs="__('guest/home.hero.about_paragraphs')"
/>
