<footer class="bg-grayscale-text-body text-white py-8 px-5">
    <div class="container mx-auto px-5 md:px-8 max-w-6xl">
        <div class="mb-8 flex justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="52" viewBox="0 0 38 33" aria-hidden="true">
                <path
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center lg:items-start mb-10 gap-12">
            ...
            <!-- Navigation Links -->
            <x-guest.navigation.footer-nav />

            <!-- Informations -->
            <x-guest.navigation.footer-infos/>

            <!--Derniers arrivants -->
            <x-guest.navigation.footer-pet/>
        ...
        <div class="text-center space-y-4 lg:flex lg:justify-between">
            <p class="text-grayscale-negative text-sm md:text-base">
                {{ __('guest/footer.copyright', ['year' => date('Y')]) }}
            </p>
            <div class="flex items-center justify-center gap-2 text-sm md:text-base text-grayscale-negative">
                <a href="{{ route('legal') }}" class="hover:underline underline-offset-2 transition-colors">
                    {{ __('guest/footer.legal.terms') }}
                </a>
                <span>•</span>
                <a href="{{ route('legal') }}" class="hover:underline underline-offset-2 transition-colors">
                    {{ __('guest/footer.legal.privacy') }}
                </a>
            </div>
        </div>
    </div>
